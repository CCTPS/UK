...
1. [Security Analysis of NHSX App](https://stateofit.com/UKContactTracing/) a security analysis, including code review, of the NHSX contact tracing app. it has initial responses from NCSC. It also contains non-technical commentary too.
